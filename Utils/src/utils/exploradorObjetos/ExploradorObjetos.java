package utils.exploradorObjetos;
...
public class ExploradorObjetos {
	...
	public static void main(String[] args) {
		...
		System.out.println( "Clase interna\n" + atributosYValoresToString( "", intt, true, false ) );
...
//Clase de prueba para parte del main() de prueba que mira atributos de una clase interna
class ClaseExterna {
	int atribExterno = 1;
